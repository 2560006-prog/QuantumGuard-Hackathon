...
const CREDENTIALS = [
  { role: 'Admin',     icon: '🛡️', email: 'admin@quantumguard.com',     pass: 'Admin@123',     color: '#7c3aed', bg: 'rgba(124,58,237,.1)', border: 'rgba(124,58,237,.3)' },
  { role: 'Validator', icon: '✅', email: 'validator@quantumguard.com', pass: 'Validator@123', color: '#d97706', bg: 'rgba(217,119,6,.1)',   border: 'rgba(217,119,6,.3)'   },
  { role: 'Farmer',    icon: '🌾', email: 'farmer@quantumguard.com',    pass: 'Farmer@123',    color: '#16a34a', bg: 'rgba(22,163,74,.1)',   border: 'rgba(22,163,74,.3)'   },
];

const FEATURES = [
  ['🔐', 'Blockchain identity protection'],
  ['🏛️', 'Access 8+ government schemes'],
  ['💰', 'Instant loan eligibility check'],
  ['📱', 'QR-based digital identity card'],
...
const CSS = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .inp { width: 100%; height: 48px; background: #1a2b1c; border: 1.5px solid #2d4a30; border-radius: 10px; padding: 0 14px; font-size: 14px; font-family: 'Nunito', sans-serif; color: #e8f5e9; outline: none; transition: border-color .2s, box-shadow .2s; }
  ...
  .quick-card-role { font-size: 12px; font-weight: 700; margin-bottom: 3px; }
        ...
        <div className="left">
          <div className="left-inner">
            <div className="brand">
              ...
              <span className="brand-name">QuantumGuard</span>
            </div>
            ...
            <div className="feat-list">
              {FEATURES.map(([icon, text]) => (
                <div className="feat-item" key={text as string}>
            ...
            <div className="demo-hint">
              ...
              {CREDENTIALS.map(c => (
                <div className="demo-row" key={c.role}>
                  <span className="demo-badge" style={{ background: c.bg, color: c.color, border: `1px solid ${c.border}` }}>
                    {c.icon} {c.role}
                  </span>
          ...
          <div className="form-box">
            ...
            <form onSubmit={handleLogin} noValidate>
              <div className="field">
                ...
                <input id="login-email" className="inp" type="email"
              ...
              <div className="field">
                ...
                <div className="pass-wrap">
                  <input id="login-pass" className="inp"
            ...
            <div className="quick-grid">
              {CREDENTIALS.map(c => (
                <div key={c.role} className="quick-card"
